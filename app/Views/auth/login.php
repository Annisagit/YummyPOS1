    <div style="background-image: url('/images/menu/toppoki.jpg'); " class="w-full flex flex-col items-center justify-center py-16">
        ...
        <?php endif ?>
        <div class="">
            <form action="/auth/login" method="post" class="border-2 border-black/10 p-8 rounded-3xl" style="background-color: aliceblue;">
                <h1 class="text-2xl font-semibold">Login YummyPOS</h1>
