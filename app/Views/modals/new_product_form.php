<input type="checkbox" id="new-product-form-modal" class="modal-toggle" />
<div class="modal">
    <form action="/produk/save_produk" method="post" class="modal-box max-w-xl" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-3">
            <div class="flex gap-3">
                <div class="form-control flex-grow">
                    ...
                    <input type="text" name="product-name" placeholder="Yummy Meals.." class="input w-full input-bordered" />
                </div>
                <div class="form-control flex-grow">
                    <label class="label">
        ...
        <div class="modal-action">
            ...
            <label for="new-product-form-modal" class="btn btn-sm btn-primary btn-outline">tutup</label>
        </div>
    </form>
</div>