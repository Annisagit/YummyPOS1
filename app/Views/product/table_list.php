            ...
            <tbody id="item_container">
                ...
                <?php foreach ($products as $product) : ?>
                    ...
                    <tr>
                        ...
                        <td class="flex gap-2">
                            <a href="/produk/detail/<?= $product->id_menu ?>" class="btn btn-sm btn-accent">detail</a>
                            <label for="<?= $product->id_menu ?>-delete-product-form-modal" type="button" class="btn btn-sm btn-error btn-outline">hapus</label>
