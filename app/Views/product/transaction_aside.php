                ...
                <table class="table w-full">
                    ...
                    <tbody id="transaction-detail-container">
                        ...
                        <?php if (count($transaction_details) != 0) : ?>
                            ...
                            <?php foreach ($transaction_details as $detail) : ?>
                                <tr>
                                    <input type="number" name="<?= $index ?>-product-id" value="<?= $detail->id_menu ?>" class="hidden">
                                    ...
                                    <input type="text" name="<?= $index ?>-product-name" value="<?= $detail->nama_menu ?>" class="hidden">
                                    ...
                                    <td class="flex gap-1">
                                        <button type="button" id="<?= $detail->id_menu ?>-<?= $detail->jumlah_produk ?>-add-action" class="add-action-btn btn btn-error btn-sm btn-square">+</button>
                                        <button type="button" id="<?= $detail->id_menu ?>-<?= $detail->jumlah_produk ?>-minus-action" class="minus-action-btn btn btn-info btn-sm btn-square">-</button>
                                    </td>
                                </tr>
                                <?php $index++ ?>
                            <?php endforeach ?>
